...
echo <<<HTML
<div id="addres">
    <input type="hidden" name="post_type" value="addres"/>
    ...
    <div class="submitForm"><input type="submit" value="Адресная доставка. Всё верно. Оформить предзаказ!" class="greenBtn" /></div>
    <script>$(".maskIntPhone").mask("+380 (99) 999-99-99");</script>
    <script>

        $("#addres input:radio").uniform();
    </script>
</div>
HTML;
?>