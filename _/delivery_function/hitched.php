...
echo <<<HTML
<div id="hitched">
    <input type="hidden" name="post_type" value="hitched"/>
    ...
    <div class="submitForm"><input type="submit" value="Отправка попуткой. Всё верно. Оформить предзаказ!" class="greenBtn" /></div>
    <script>$(".maskIntPhone").mask("+380 (99) 999-99-99");</script>
    <script>

        $("#hitched input:radio").uniform();
    </script>
</div>
HTML;
?>