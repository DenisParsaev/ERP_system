...
echo <<<HTML
<div id="addres_post">
    <input type="hidden" name="post_type" value="intime-addres"/>
    ...
    <div class="submitForm"><input type="submit" value="InTime (Адресная). Всё верно. Оформить предзаказ!" class="greenBtn" /></div>
