...
echo <<<HTML
<div id="shop_post">
    <input type="hidden" name="post_type" value="intime-shop"/>
    ...
    <div class="submitForm"><input type="submit" value="InTime (Отделение). Всё верно. Оформить предзаказ!" class="greenBtn" /></div>
