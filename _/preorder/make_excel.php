                ...
                if($place==$shop)
                {
                    ...
                    if($result_status!="0")
                    {
                        ...
                        for($i=0;$i<$order_count-1;$i++)
                        {
                            ...
                            $aSheets->setCellValue('E'.$j.'',''.$order_arr[2].'');
...
if($shop==1)
{
    $file = "preorder[office|rabica](".$date.").xlsx";
}
if($shop==2)
{
    $file = "preorder[office|armasetka](".$date.").xlsx";
}
if($shop==3)
{
    $file = "preorder[office|kirpich](".$date.").xlsx";
}
if($shop==4)
{
    $file = "preorder[office|razborka](".$date.").xlsx";
}
