<div class="table" style="margin-top: 20px;">
    <div class="head">
        <h5 style="width: 90%;text-align: center;">
            <input type="button" value="Распечатать" class="blueBtn  ml10" onclick="preorder_shop_kirpish()" />
        </h5>
    </div>
                    ...
                    echo '<td style="vertical-align: middle;width: 200px;">
                            <center>
                                <div id="result_ready_preorder_3_'.$result['id'].'">
                                    <input type="button" style="width:95px;" name="submit" onClick = "ready_succes(this)" id="'.$result['id'].'|'.$_SESSION['id'].'|3" value="Готов" class="greenBtn" />
                                    <input type="button" style="width:95px;margin-left:10px;" name="submit" onClick = "return_order(this)" id="'.$result['id'].'|'.$_SESSION['id'].'|3" value="Отказ" class="redBtn" />
                                </div>
                            </center>
                         </td>
                         </tr>';
