<div class="widget" style="margin-top: 10px;">
    <div class="head"><h5 class="iImageList">Шаповалов Евгений Валерьевич</h5></div>
    <div class="body">
        <div class="list arrow2Blue">
            <span class="legend">Телефон</span>
            <ul>
                <li>38(096)800-92-87</li>
            </ul>
...
<div class="table" style="margin-top: 20px;">
    <div class="head">
        <h5 style="width: 90%;text-align: center;">
            <input type="button" value="Цеховской" class="blueBtn  ml10" onclick="preorder_shop_razborka()" />
            <input type="button" value="Офисный" class="greenBtn  ml10" onclick="preorder_office_razborka()" />
        </h5>
    </div>
    <table  cellpadding="0" cellspacing="0" border="0" class="display" id="example_3"  >
        ...
        <?php
        $query = "SELECT * FROM preorder_willingness,scroll_call WHERE preorder_willingness.call_id=scroll_call.id AND preorder_willingness.shop_four='1' AND scroll_call.status='8'";
            ...
            for($i=0;$i<$order_count-1;$i++)
            {
                ...
                if($place==4)
                {
                    ...
                    echo '<td style="vertical-align: middle;">
                            <center>
                                <div id="result_ready_preorder_4_'.$result['id'].'">
                                    <input type="button" style="width:95px;" name="submit" onClick = "ready_succes(this)" id="'.$result['id'].'|'.$_SESSION['id'].'|4" value="Готов" class="greenBtn" /><br>
                                    <input type="button" style="width:95px;margin-top:5px;" name="submit" onClick = "return_order(this)" id="'.$result['id'].'|'.$_SESSION['id'].'|4" value="Отказ" class="redBtn" />
                                </div>
                            </center>
                         </td>
                         </tr>';
