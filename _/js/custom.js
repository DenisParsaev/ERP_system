$(function() {
	...
	$(".maskPhone").mask("+380 (99) 999-99-99");
	$(".maskPhoneExt").mask("(999) 999-9999? x99999");
	$(".maskIntPhone").mask("+380 (99) 999-99-99");
	...
	oTable = $('#example').dataTable({
		...
		"oLanguage": {
			"sLengthMenu": "<span>Показать по:</span> _MENU_",
			"oPaginate": { "sFirst": "Начало", "sLast": "Конец", "sNext": ">", "sPrevious": "<" }
		}
	});
