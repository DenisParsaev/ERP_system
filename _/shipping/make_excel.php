...
while ($result = mysql_fetch_array($res))
    {
        ...
        if($arr[0]=="INTIME" || $arr[0]=="NP"){
            if($arr[1]=="OTDEL") {
                    ...
                    $aSheets->mergeCells('H'.$j.':H'.$subject.'');
                    ...
                    for($i=0;$i<$order_count-1;$i++)
                    {
					    ...
					    $aSheets->setCellValue('B'.$j.'',''.$mass[1].'');
                        $aSheets->setCellValue('C'.$j.'',''.$arr[4].' №'.$arr[2].'');
                        $aSheets->setCellValue('F'.$j.'',''.$order_arr[0].'');
                        $aSheets->setCellValue('G'.$j.'',''.$order_arr[1].'');
                        $aSheets->setCellValue('D'.$j.'',''.$name[0].'');
                        $name[1]=preg_replace('/^\+?380? ?\(/','0',$name[1]);
                        $name[1]=preg_replace('/\ /','',$name[1]);
						$name[1]=preg_replace('/\)/','-',$name[1]);
                        $aSheets->setCellValue('E'.$j.'',''.$name[1].'');
                        $aSheets->setCellValue('H'.$j.'',''.$sum.'');
                        $aSheets->setCellValue('K'.$j.'',''.$plat.'');
                        $aSheets->setCellValue('L'.$j.'',''.$manager.'');
                        $j++;
                    }
			}
					elseif($arr[1]=="ADDRES")
                {
                    ...
                    for($i=0;$i<$order_count-1;$i++)
                    {
                        ...
                        $aSheets->setCellValue('A'.$j.'',''.$number.'');
                        $aSheets->setCellValue('B'.$j.'',''.$mass[1].'');
                        $aSheets->setCellValue('C'.$j.'',''.$arr[3].'');
                        $aSheets->setCellValue('F'.$j.'',''.$order_arr[0].'');
                        $aSheets->setCellValue('G'.$j.'',''.$order_arr[1].'');
                        $aSheets->setCellValue('D'.$j.'',''.$name[0].'');
                        $name[1]=preg_replace('/^\+?380? ?\(/','0',$name[1]);
        ...
        else
            {
                ...
                $aSheets->mergeCells('C'.$j.':C'.$subject.'');
                $aSheets->mergeCells('D'.$j.':D'.$subject.'');
                $aSheets->mergeCells('G'.$j.':G'.$subject.'');
                $aSheets->mergeCells('H'.$j.':H'.$subject.'');
                $aSheets->mergeCells('I'.$j.':I'.$subject.'');
                ...
                for($i=0;$i<$order_count-1;$i++)
                {
                    ...
                    $aSheets->setCellValue('A'.$j.'',''.$number.'');
                    $aSheets->setCellValue('B'.$j.'',''.$mass[1].'');
                    $aSheets->setCellValue('C'.$j.'',''.$arr[2].'');
                    $aSheets->setCellValue('D'.$j.'',''.$name[0].'');
                    $name[1]=preg_replace('/^\+?380? ?\(/','0',$name[1]);
                    $name[1]=preg_replace('/\ /','',$name[1]);
					$name[1]=preg_replace('/\)/','-',$name[1]);
