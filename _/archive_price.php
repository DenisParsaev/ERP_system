...
<div class="wrapper">
    ...
    <!-- Content -->
    <div class="content">
        <div class="title"><h5>Архив прайс листов</h5></div>

        <!-- Tables inside tabs -->
        <div class="widget first rightTabs">
            <div class="head"><h5 class="iFrames">Печерень прайс листов</h5></div>
            <div class="tabs">
                <ul>
                    <li><a href="archive_price.php#tab1">Рабица</a></li>
                </ul>
