...
$text="".$date_add.": ".$manager_name." указал что заказ отправлен в отгруки";
$query_log = "INSERT INTO log (`call_id`,`text_log`) VALUES ('".$id."','".$text."')";
$res_log = mysql_query($query_log);

$query_stat = "UPDATE `scroll_call` SET `status`='7',`date_shipped`='".$date_update."', `date_update`='".$date_add."' WHERE scroll_call.status = 15";
