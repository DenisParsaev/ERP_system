...
echo <<<HTML
<div id="two_pillars">
    <input type="hidden" name="post_type" value="two_pillars"/>
    ...
    <div class="rowElem">
        ...
        <div class="formRight">
            <input type="text" name="preorder_payer_name" placeholder="Иванов Иван Иванович" required style="margin-right:10px;width: 550px;"/>
            Телефон:
            <input class="maskIntPhone" style="width: 125px;margin-left: 10px;" type="text" name="preorder_payer_phone" placeholder="+38(066)666-66-66" required />
        </div>
    </div>
    <div class="rowElem">
    ...
    <script>
        ...
        $("#two_pillars input:radio").uniform();
    </script>
</div>
HTML;
?>