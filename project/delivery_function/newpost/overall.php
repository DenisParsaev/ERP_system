...
<div id="newpost">
    <div class="rowElem noborder">
        ...
        <div class="formRight">
            <input type="radio" name="type_post" id="type_post_shop" onclick="select_post_type(1,0,$full_cost,$prepay_sum,$call_id)"/>
            <label for="type_post_shop">Отделение</label>

            <input type="radio" name="type_post" id="type_post_addres" onclick="select_post_type(0,0,$full_cost,$prepay_sum,$call_id)"/>
