...
echo <<<HTML
<div id="addres_post">
    <input type="hidden" name="post_type" value="newpost-addres"/>
    ...
    <div class="rowElem">
        <label>Адрес:</label>
        <div class="formRight">
            <input required type="text" name="addres"  required />
        </div>
    </div>
    <div class="rowElem">
        <label>Вес:</label>
    ...
    <div class="submitForm"><input type="submit" value="Новая Почта (Адресная). Всё верно. Оформить предзаказ!" class="greenBtn" /></div>
    <script>$(".maskIntPhone").mask("+380 (99) 999-99-99");</script>
    <script>

        $("#addres_post input:radio").uniform();
    </script>
</div>
HTML;
?>