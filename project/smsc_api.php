<?php
// SMSC.UA API (smsc.ua) версия 3.4 (05.03.2015)

define("SMSC_LOGIN", "DenisParsaev");			// логин клиента
define("SMSC_PASSWORD", "dd7f1cb02e54e35124ef4996be670159");	// пароль или MD5-хеш пароля в нижнем регистре
...
function send_sms($phones, $message,  $sender = false, $query = "", $files = array())
{
...
{
	$url = (SMSC_HTTPS ? "https" : "http")."://smsc.ua/sys/$cmd.php?login=".urlencode(SMSC_LOGIN)."&psw=".urlencode(SMSC_PASSWORD)."&fmt=1&charset=".SMSC_CHARSET."&".$arg;
