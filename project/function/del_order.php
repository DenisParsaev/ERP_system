...
$text="".$date_add.": Менеджер ".$manager_name." удалил звонок";
$query_log = "INSERT INTO log (`call_id`,`text_log`) VALUES ('".$id."','".$text."')";
$res_log = mysql_query($query_log);

$query_stat = "UPDATE `scroll_call` SET `status`='99', `date_update`='".$date_add."' WHERE id='".$id."'";
$res_stat = mysql_query($query_stat);

echo '<script language="JavaScript">window.location.href = "/order.php"</script>';