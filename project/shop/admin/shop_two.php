...
<div class="table" style="margin-top: 20px;">
    <div class="head">
        <h5 style="width: 90%;text-align: center;">
            <input type="button" value="Цеховской" class="blueBtn  ml10" onclick="preorder_shop_armasetka()" />
            <input type="button" value="Офисный" class="greenBtn  ml10" onclick="preorder_office_armasetka()" />
        </h5>
    </div>
                    ...
                    echo '<td style="vertical-align: middle;">
                            <center>
                                <div id="result_ready_preorder_2_'.$result['id'].'">
                                    <input type="button" style="width:95px;" name="submit" onClick = "ready_succes(this)" id="'.$result['id'].'|'.$_SESSION['id'].'|2" value="Готов" class="greenBtn" /><br>
                                    <input type="button" style="width:95px;margin-top:5px;" name="submit" onClick = "return_order(this)" id="'.$result['id'].'|'.$_SESSION['id'].'|2" value="Отказ" class="redBtn" />
                                </div>
                            </center>
                         </td>
                         </tr>';
